...
> Current status: **0.26.0-rc2**. This is a release candidate, not the final stable release.
...
- Built-in downloads with background progress and media/HLS support
...
- Custom themes, wallpapers, launcher icons, toolbar placement, and interface density
