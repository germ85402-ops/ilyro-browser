...
> Current status: **0.26.0-rc19**. This is a release candidate, not the final stable release.
...
- Custom themes, phone and tablet wallpapers chosen automatically, launcher icons, toolbar placement, and interface density
