...
> Current status: **0.26.0**. Signed Android release with GeckoView, built-in protection and optional account sync.
...
- Six built-in wallpaper presets for each of the light and dark themes, switched automatically with the browser theme, plus custom images, launcher icons, toolbar placement, and interface density
- Wallpaper collections are grouped by theme; interface accents can follow wallpapers automatically or use a chosen color
