(() => {
  ...
  const russianTranslations = {
    ...
    'hero.artAlt': 'Новая вкладка ILYRO с обоями «Обсидиановая арка»',
    ...
    'screenshots.intro': 'Посмотрите интерфейс ILYRO на английском — на главной вкладке новые обои «Обсидиановая арка».',
    'screenshots.link': 'Смотреть все скриншоты',
    'screenshots.newTab.alt': 'Новая вкладка ILYRO',
    'screenshots.newTab.title': 'Новая вкладка',
    'screenshots.newTab.copy': 'Обсидиановая арка в кобальтовом свете',
