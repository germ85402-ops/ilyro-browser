...
fun IlyroApp() {
    ...
    val colors = if (darkTheme) {
        darkColorScheme(
            ...
            primaryContainer = Color(0xFF2B2D32),
            onPrimaryContainer = Color(0xFFF3F3F4),
            secondary = Color(0xFFC3C5CA),
            onSecondary = Color(0xFF191A1E),
            secondaryContainer = Color(0xFF2A2C31),
            onSecondaryContainer = Color(0xFFF0F1F2),
            tertiary = Color(0xFFC3C5CA),
            onTertiary = Color(0xFF191A1E),
            tertiaryContainer = Color(0xFF2A2C31),
            onTertiaryContainer = Color(0xFFF0F1F2),
            background = Color(0xFF111214),
            onBackground = Color(0xFFF1F2F3),
            surface = Color(0xFF191B1F),
            onSurface = Color(0xFFF1F2F3),
            surfaceVariant = Color(0xFF25272B),
            onSurfaceVariant = Color(0xFFC0C2C7),
            outline = Color(0xFF85888F),
            outlineVariant = Color(0xFF45474C),
...
private fun BrowserScreen(
    ...
    DisposableEffect(showMedia, activeTab.id, mediaRevision, mediaEnabledForPage) {
        if (!showMedia || !mediaEnabledForPage) {
            ...
            if (candidate == null) {
                ...
                val cancelResolver = downloadController.resolveMediaQualities(
